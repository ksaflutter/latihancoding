...
class BelajarHalSatu extends StatefulWidget {
  final String nama;
  const BelajarHalSatu({super.key, required this.nama});

  @override
  State<BelajarHalSatu> createState() => _BelajarHalSatuState();
}

class _BelajarHalSatuState extends State<BelajarHalSatu> {
        ...
        return Column(
          ...
          children: [
            DropdownButton<String>(
              ...
              hint: Text(
                "Pilih kategori",
                style: TextStyle(color: darkMode ? Colors.amber : Colors.black),
              ),
